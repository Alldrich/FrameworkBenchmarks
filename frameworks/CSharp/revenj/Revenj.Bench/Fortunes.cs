...
{
    if ((!typeof(global::System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<int, string>>).IsAssignableFrom(this.Session["fortunes"].GetType())))
    {
...
if ((!fortunesValueAcquired))
{
    object data = global::System.Runtime.Remoting.Messaging.CallContext.LogicalGetData("fortunes");
    if ((data != null))
    {
        if ((!typeof(global::System.Collections.Generic.List<System.Collections.Generic.KeyValuePair<int, string>>).IsAssignableFrom(data.GetType())))
        {
            this.Error("The type \'System.Collections.Generic.List<System.Collections.Generic.KeyValuePair" +
                    "<int, string>>\' of the parameter \'fortunes\' did not match the type of the data p" +
                    "assed to the template.");
